    ...
    return <>
        <div className="home-header">
            <div className="home-header-inner">  
                ...
                <form className="home-hero-from" onSubmit={(evt) => evt.preventDefault()}>
                    <Input classList="home-hero-search" typeInput="search" placeHolder="Search for food, coffe, etc.."/>
                </form>
            </div>
            ...
            <nav className="home-header-nav">
                <ul className="home-header-list">
                    <li className="home-header-item">
                        <NavLink className={({isActive}) => isActive ? "home-header-link home-header-link-active" : "home-header-link"} to="/home" end>Hot Dishes</NavLink>
                    </li>
                    <li className="home-header-item">
